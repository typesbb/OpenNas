...
![连接设置](docs/screenshots/connection-settings.jpg)
...
![相册列表](docs/screenshots/albums.jpg)&emsp;![相册排序](docs/screenshots/albums-sort.jpg)
...
![相册详情](docs/screenshots/album-detail.jpg)&emsp;![照片排序](docs/screenshots/album-detail-sort.jpg)
...
![任务 - 空状态](docs/screenshots/tasks-empty.jpg)&emsp;![备份后删除确认](docs/screenshots/tasks-delete-confirm.jpg)
...
![备份规则](docs/screenshots/tasks-rule.jpg)&emsp;![备份进度](docs/screenshots/tasks-progress.jpg)
...
![我的](docs/screenshots/profile.jpg)&emsp;![备份策略](docs/screenshots/backup-settings.jpg)
